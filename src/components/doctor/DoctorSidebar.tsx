...
import { 
  LayoutDashboard, Search, Key, Activity, FileText, Sparkles, Bell, User, Settings, LogOut, X
} from 'lucide-react';
...
export const DoctorSidebar: React.FC<SidebarProps> = ({
  currentTab,
  onTabChange,
  onSignOut,
  onCloseMobile
  ...
  const primaryNav = [
    ...
    { id: 'timeline', label: 'Patient Timeline', icon: <Activity size={18} /> },
  ...
  return (
    <aside className="patient-sidebar doctor-sidebar">
      {/* Sidebar Header / Logo */}
      ...
      <div className="sidebar-nav-sections">
        ...
        <div className="sidebar-nav-section">
          <span className="section-label">Clinician Workspace</span>
